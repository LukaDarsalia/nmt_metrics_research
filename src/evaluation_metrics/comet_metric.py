"""
COMET metric implementation for NMT evaluation_metrics.

This module provides COMET score calculation using the comet library.
COMET uses neural-based evaluation_metrics and requires source, hypothesis, and reference texts.
...
class COMETMetric(BaseMetric):
    ...
    def calculate_scores(
        ...
        """
        Calculate COMET scores using neural-based evaluation_metrics.
        ...
        try:
            ...
            model_output = self._comet_model.predict(data, batch_size=self.batch_size)
