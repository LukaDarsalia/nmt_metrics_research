"""
Abstract base class for NMT processors metrics.
...
class BaseMetric(ABC):
    """Abstract base class for all NMT processors metrics."""
    ...
    def load_data(self, input_path: str) -> pd.DataFrame:
        """
        Load processors data from CSV file.

        Args:
            input_path: Path to input CSV file

        Returns:
            DataFrame with processors data
        """
